...
const ACTIVE_CAMPAIGNS = [
  {
    ...
    spots: 3,
    isNew: true,
    description: 'Looking for tech creators to review our latest AI-powered productivity suite.'
  },
  {
    id: '2',
    brand: 'EcoVibe',
    ...
    spots: 5,
    isNew: true,
    description: 'Showcase our 100% organic hemp collection in your summer lifestyle reels.'
  },
  {
    id: '3',
    brand: 'FitFlow',
    ...
    spots: 2,
    isNew: false,
    description: 'Collaborate with FitFlow to lead a virtual yoga series for our community.'
  },
  {
    id: '4',
    ...
    spots: 4,
    isNew: false,
    description: 'Premium skincare creators needed for high-aesthetic night-time routine content.'
  }
];
        ...
        <div className="flex flex-col md:flex-row md:items-end justify-between mb-12 gap-6">
          <div className="max-w-2xl">
            ...
            <p className="text-muted-foreground text-lg">
              Fresh collaborations are added every hour. Discover brands looking for your unique voice and style.
            </p>
          </div>
            ...
            <motion.div key={campaign.id} variants={itemVariants}>
              <Card className="h-full flex flex-col border-slate-200 hover:border-primary/40 transition-all duration-300 hover:shadow-xl bg-white group">
                <CardHeader className="p-6 pb-2">
                  ...
                  <p className="text-sm text-primary font-bold mt-1">{campaign.brand}</p>
                </CardHeader>
                ...
                <CardFooter className="p-6 pt-0 mt-auto">
                  <div className="w-full flex items-center justify-between">
                    ...
                    <Button variant="ghost" size="sm" className="text-xs font-bold hover:text-primary p-0 h-auto flex items-center gap-1 group/btn">
                      Apply Now <ExternalLink className="h-3 w-3 group-hover/btn:scale-110 transition-transform" />
                    </Button>
                  </div>
                </CardFooter>
              </Card>
