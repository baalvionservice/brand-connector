...
export async function PATCH(
  ...
  if (body.deliverables) {
    ...
    body.deliverables.forEach((d: any) => {
      const price = bases[d.creatorTier as CreatorTier] * multis[d.type as DeliverableType];
  ...
  proposals[index] = { ...proposals[index], ...body, updatedAt: new Date().toISOString() };
